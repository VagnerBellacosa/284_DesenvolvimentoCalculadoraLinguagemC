// Esse código é uma simulação de uma calculadora simples de números inteiros com as 5 operações básicas: adição, subtração, multiplicação e divisão. 
// Além disso é mostrado o resultado em outros sistemas como o binário, octal e o hexadecimal.
